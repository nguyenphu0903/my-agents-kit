#!/usr/bin/env python3
"""
Auto Preview - Agent Kit
==============================
Manages (start/stop/status) the local development server for previewing the application.

Usage:
    python .my-agents-kit/scripts/auto_preview.py start [port]
    python .my-agents-kit/scripts/auto_preview.py stop
    python .my-agents-kit/scripts/auto_preview.py status
"""
