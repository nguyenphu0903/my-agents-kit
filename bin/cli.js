...
function initAgentKit(options) {
    ...
    const shouldGenerateOpenCodeAssets = true;
    ...
    try {
        ...
        if (fs.existsSync(devSourcePath)) {
            ...
            if (shouldGenerateOpenCodeAssets) {
                generateOpenCodeAssets(targetDir);
            }
...
function generateOpenCodeAssets(targetDir) {
    generateOpenCodeAgents(targetDir);
    generateOpenCodeSkills(targetDir);
}

function generateOpenCodeAgents(targetDir) {
    const sourceAgentsDir = path.join(targetDir, KIT_DIR, "agents");
    ...
    const targetAgentsDir = path.join(targetDir, OPENCODE_AGENTS_DIR);
    fs.mkdirSync(targetAgentsDir, { recursive: true });
...
function generateOpenCodeSkills(targetDir) {
    const sourceSkillsDir = path.join(targetDir, KIT_DIR, "skills");
